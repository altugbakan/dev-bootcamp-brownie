...
contract PriceExercise is ChainlinkClient {
    ...
    /*
     * Requests the latest price of BTC/USD.
     */
    ...
    /*
     * Compares the BTC/USD price data requested from the cryptocompare API
     * with the oracle price feed obtained from Chainlink.
     */
    function fulfill(bytes32 _requestId, int256 _price) public recordChainlinkFulfillment(_requestId) {
        priceFeedGreater = getLatestPrice() > _price;
    }
